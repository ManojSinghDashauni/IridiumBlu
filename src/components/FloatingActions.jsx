...
import { SITE, whatsappLink, bookingMessage } from "../lib/data/site";
...
export function ExitIntent() {
  ...
  useEffect(() => {
    if (
      ...
      sessionStorage.getItem("mrh-exit")
    ) {
      setDismissed(true);
      return;
    }
  ...
  const close = () => {
    ...
    if (typeof sessionStorage !== "undefined") {
      sessionStorage.setItem("mrh-exit", "1");
    }
  };
        ...
        >
          ...
          >
            ...
            <h3 className="mt-2 text-2xl font-bold">
              Get the best rate in Munsiyari
            </h3>

            <p className="mt-2 text-muted-foreground">
              Message us now and lock in flexible self-drive rentals
              with free helmets & roadside assistance.
            </p>
